    ...
    if (isset($_POST['update'])) {
        ...
        if (!empty($image)) {
            if ($image_size > 2000000) {
                ...
                $update_product->execute([$image, $product_id]);
                        ...
                        <div class="input-field">
                            ...
                            <?php if($fetch_product['image'] != ''){ ?>
                                ...
                                <div class="flex-btn">
                                    ...
                                    <a href="view_product.php" class="btn" style="width: 49%; text-align:center; height:3rem; margin: top 0.7rem;">go back</a>
                                </div>
                            <?php } ?>
                        </div>
                        <div class="flex-btn">
                            <input type="submit" name="update" value="update product" class="btn">
                            <input type="submit" name="delete_product" class="btn">
                        </div>
                    </form>
                </div>
                <?php
